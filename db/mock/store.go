...
// Source: github.com/codernirmalnp/golang/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.CreateTransferParams) (db.TransferTxResults, error) {
	m.ctrl.T.Helper()
